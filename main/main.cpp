...
int main()
{
    ...
    // std::shared_ptr<ng2::Object> triangle = routine.add_polygon(tri_vert, ng2::Vec2{240.f, 240.f}, 0.f);
    ...
    std::shared_ptr<ng2::Object> hexagon = routine.add_polygon(hexa_vert, ng2::Vec2{400.f, 300.f}, 0.f);
