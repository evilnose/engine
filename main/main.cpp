...
int main()
{
    ...
    ng2::objptr hexagon = routine.add_polygon(hexa_vert, ng2::Vec2{300.f, 300.f}, 0.f);
    ...
    ng2::objptr rect1 = routine.add_polygon(rect1_vert, ng2::Vec2{200.f, 300.f}, 0.f);
    rect1->velocity.x = 80.f;
    ...
    ng2::objptr rect2 = routine.add_polygon(rect2_vert, ng2::Vec2{400.f, 300.f}, 0.f);
    rect2->velocity.x = -50.f;
    // rect2->ang_velocity = -2.f;
